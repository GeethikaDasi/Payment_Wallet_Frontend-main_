...
getAccount.addEventListener("click", async (e) => {
    ...
    if(aId == 0){
        ...
        window.location.href = "http://127.0.0.1:5500/project/display_details.html"
    }  
});
...
createAccount.addEventListener("click", async (e) => {
        ...
        console.log(aId);
        if(aId == 0){
            window.location.href = "http://127.0.0.1:5500/project/create_account.html"
        }
        else {
...
deleteAccount.addEventListener("click", async (e) => {
        ...
        if(aId == 0){
            ...
            window.alert("Account Detected!");
            window.location.href = "http://127.0.0.1:5500/project/delete_account.html"
        }
});
...
paymentWallet.addEventListener("click", async (e) => {
        ...
        if(aId == 0){
            ...
            window.location.href = "http://127.0.0.1:5500/project/payment_wallet.html"
        }
});